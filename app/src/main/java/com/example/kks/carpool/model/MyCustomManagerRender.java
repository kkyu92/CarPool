...
public class MyCustomManagerRender extends DefaultClusterRenderer<CustomMarker> {
    ...
    public MyCustomManagerRender(Context context, GoogleMap map, ClusterManager<CustomMarker> clusterManager) {
