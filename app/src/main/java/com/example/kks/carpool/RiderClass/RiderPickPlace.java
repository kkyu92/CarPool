...
public class RiderPickPlace extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(RiderPickPlace.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        gMap.setOnCameraIdleListener(new OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(RiderPickPlace.this);
