...
import com.example.kks.carpool.appRTC.AppRTCAudioManager.AudioDevice;
import com.example.kks.carpool.appRTC.AppRTCAudioManager.AudioManagerEvents;
import com.example.kks.carpool.appRTC.AppRTCClient.RoomConnectionParameters;
import com.example.kks.carpool.appRTC.AppRTCClient.SignalingParameters;
import com.example.kks.carpool.appRTC.PeerConnectionClient.DataChannelParameters;
import com.example.kks.carpool.appRTC.PeerConnectionClient.PeerConnectionParameters;
...
import static com.example.kks.carpool.appRTC.CallFragment.contactView;
...
//            unbindService(conn);
    ...
    public void VideoCall(String toDriver) {
      if (toDriver.equals("상대방이 거절 하였습니다.")) {
        Toast.makeText(ms, "상대방이 거절 하였습니다.", Toast.LENGTH_SHORT).show();
        disconnect();
      }
    }
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (RealService.serviceIntent == null) {
      serviceIntent = new Intent(CallActivity.this, RealService.class);
