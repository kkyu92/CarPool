...
public class MainActivity extends AppCompatActivity implements RecyclerViewAdapterCallback, GoogleApiClient.OnConnectionFailedListener {

    private EditText startText, endText;
    private RecyclerView recyclerView_start, recyclerView_end;
    public static com.example.kks.carpool.RecyclerViewAdapter adapter;
...
//                recyclerView_end.setVisibility(View.VISIBLE);
        ...
        mPlacePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mPlacePicker.getText().toString().contains("출발")) {
                    Log.e("출발이냐도착이냐::::", "출발이다");
                    Intent intent = new Intent(MainActivity.this, google_picker.class);
    ...
    private void layoutInit_start() {
        ...
        adapter = new com.example.kks.carpool.RecyclerViewAdapter();
...
//        gMap.clear();
//
//        gMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(google_map.this));
//
//        if (placeInfo != null) {
//            try {
