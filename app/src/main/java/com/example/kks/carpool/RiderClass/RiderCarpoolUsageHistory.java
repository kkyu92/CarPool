...
import com.example.kks.carpool.DriverClass.DrivingAdapter;
...
public class RiderCarpoolUsageHistory extends AppCompatActivity {
...
//                        noList.setVisibility(View.INVISIBLE);
            ...
            public void onFailure(Call<ArrayList<ShowRating>> call, Throwable t) {
                Toast.makeText(RiderCarpoolUsageHistory.this, "운행리스트 불러오기 실패", Toast.LENGTH_SHORT).show();
