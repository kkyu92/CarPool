...
import com.example.kks.carpool.PopUpMachingMessage;
...
public class RiderStartMap extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener {
...
//    public static final String IP = "192.168.0.81";
    ...
    public RealService.ICallback mCallback = new RealService.ICallback() {
        ...
        public void RiderRemoteCall(String msg) {
            ...
            Toast.makeText(RiderStartMap.this, " 매칭 요청완료!! ", Toast.LENGTH_SHORT).show();
//            Log.e("받은 메세지 ", );
            ...
            Intent intent = new Intent(RiderStartMap.this, RiderWaitingDriver.class);
...
//                Toast.makeText(this, "Floating Action Button", Toast.LENGTH_SHORT).show();
            ...
            case R.id.fab1:
                ...
                Intent intent = new Intent(RiderStartMap.this, RiderCarpoolUsageHistory.class);
                startActivity(intent);
                break;
            case R.id.fab2:
                anim();
                Toast.makeText(this, "평점", Toast.LENGTH_SHORT).show();
                Intent point = new Intent(RiderStartMap.this, RiderMyPoint.class);
                startActivity(point);
                break;
        }
    }
...
//            gMap.addMarker(s_markerOptions);
        ...
        start_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(RiderStartMap.this, RiderSearchPlace.class);
...
//                intent.putExtra("Lon", longitude);
        ...
        time_set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(RiderStartMap.this, new DatePickerDialog.OnDateSetListener() {

                    @Override
                    public void onDateSet(DatePicker datePicker, int year, int monthOfYear, final int dayOfMonth) {

                        date.set(year, monthOfYear, dayOfMonth);
                        timePickerDialog = new TimePickerDialog(RiderStartMap.this, AlertDialog.THEME_HOLO_LIGHT,
                                    ...
                                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                        ...
                                        if (dayOfMonth == Calendar.getInstance().get(Calendar.DAY_OF_MONTH)) {
                                            if (hourOfDay < Calendar.getInstance().get(Calendar.HOUR_OF_DAY)) {
                                                Toast.makeText(RiderStartMap.this, "이전 시간은 선택할 수 없습니다.", Toast.LENGTH_SHORT).show();
...
//                                        // 요일선택 dialog
//                                        AlertDialog.Builder mBuilder = new AlertDialog.Builder(RiderStartMap.this);
...
//
//                        if (hour < h) {
//                            Toast.makeText(RiderStartMap.this, "다음날로 설정하였습니다.", Toast.LENGTH_SHORT).show();
//                            date += 1;
//                            day += 1;
//
//                            String dayday = "요일";
...
//
//                timePickerDialog = new TimePickerDialog(RiderStartMap.this, AlertDialog.THEME_HOLO_LIGHT, onTimeSetListener, hour, minute, false);
//                timePickerDialog.setIcon(R.drawable.time);
//                timePickerDialog.setTitle("출발시간을 설정하세요");
//                timePickerDialog.getWindow().setGravity(Gravity.BOTTOM);
//
...
//                            mBuilder.setIcon(R.drawable.);
                            ...
                            mBuilder.setPositiveButton("재요청", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Toast.makeText(RiderStartMap.this, "매칭 재요청.", Toast.LENGTH_SHORT).show();
                    ...
                    // 알림 팝업
                    Intent intent = new Intent(RiderStartMap.this, PopUpMachingMessage.class);
                    startActivity(intent);
...
//                startActivity(intent);
                    ...
                    mBuilder.setPositiveButton("요청취소", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            cancel.setVisibility(View.VISIBLE);
                            request_car.setText("카풀 요청");
                            Toast.makeText(RiderStartMap.this, "매칭 요청을 취소하였습니다.", Toast.LENGTH_SHORT).show();
            ...
            location.addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        Geocoder geocoder = new Geocoder(RiderStartMap.this);
...
//                new SocketClient(i + "@" + USER_NAME).start();
                if (RealService.serviceIntent == null) {
                    serviceIntent = new Intent(RiderStartMap.this, RealService.class);
            ...
            public void onFailure(Call<RequestCar> call, Throwable t) {
                Toast.makeText(RiderStartMap.this, "카풀 요청 실패", Toast.LENGTH_SHORT).show();
            }
        });
    }
