...
import com.example.kks.carpool.DriverClass.start_Driver;
import com.example.kks.carpool.RiderClass.RiderStartMap;
...
import static com.example.kks.carpool.LoginSignup.Login.prefConfig;
import static com.example.kks.carpool.LoginSignup.Login.mGoogleApiClient;
...
//                facebook_logout.performClick();
        ...
        start_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Result.this, RiderStartMap.class);
