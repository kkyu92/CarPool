...
import com.example.kks.carpool.KakaoPayment;
...
import static com.example.kks.carpool.RiderClass.RiderStartMap.DEFAULT_ZOOM;

public class RiderWaitingDriver extends AppCompatActivity implements OnMapReadyCallback {

    private String TAG = "RiderWaitingDriver";
    // 레이아웃
    ...
    public RealService.ICallback mCallback = new RealService.ICallback() {
        ...
        public void LocationCall(float bearing, double lat, double lon) { // 위치변화감지 // 탑승유무 확인
            if (bearing == 999 && lat == 999 && lon == 999) { // 탑승유무 확인
                final AlertDialog.Builder mBuilder = new AlertDialog.Builder(RiderWaitingDriver.this);
                ...
                mBuilder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        Toast.makeText(RiderWaitingDriver.this, "탑승을 확인했습니다.", Toast.LENGTH_SHORT).show();
...
//                    animateMarker(new LatLng(target_lat, target_lon), new LatLng(myLat, myLon), dMarker);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (RealService.serviceIntent == null) {
            serviceIntent = new Intent(RiderWaitingDriver.this, RealService.class);
...
//        gMapContainer.setVisibility(View.VISIBLE);
        ...
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mBuilder.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
                        Toast.makeText(RiderWaitingDriver.this, "카풀 매칭을 취소했습니다.", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
        ...
        chat_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RiderWaitingDriver.this, Chatting.class);
        ...
        call_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RiderWaitingDriver.this, ConnectActivity.class);
        ...
        requestInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(RiderWaitingDriver.this, "요청정보 상세보기", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(RiderWaitingDriver.this, PopUpRequestInfo.class);
...
//                    driver_email.setText("요금결제를 진행중입니다.");
        ...
        payStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(RiderWaitingDriver.this, KakaoPayment.class);
...
//            Toast.makeText(getContext(), "등록을 취소 하였습니다.", Toast.LENGTH_SHORT).show();
        ...
        if (requestCode == 1933) {
            ...
            unbindService(conn);
            finish();
            Intent intent = new Intent(RiderWaitingDriver.this, Rating.class);
